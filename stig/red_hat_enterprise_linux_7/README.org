...
* Features
| Finding ID | Description                       | Automatic Remediation Provided |
|------------+-----------------------------------+--------------------------------|
| V-204443   | ypserv must not be installed      | yes                            |
| V-204442   | rsh-server must not be installed  | yes                            |
| V-204621   | tftp-server must not be installed | yes                            |
